...
export async function addGroup(name) {
    try {
        const response = await fetch("http://localhost:5000/api/student/groups/new", {
            method: "POST",
            headers: {
...
export const updateGroup = async (id, name) => {
    try {
        const response = await fetch(`http://localhost:5000/api/student/groups/update`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json",
            },
...
export async function deleteGroup(id) {
    try {
        const response = await fetch(`http://localhost:5000/api/student/groups/delete/${id}`, {
            method: "DELETE",
        });
